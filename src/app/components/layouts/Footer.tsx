        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <Link
                  href="https://www.linkedin.com/in/alghifarirasyidzola"
                  target="_blank"
              ...
              <Link
                href="https://github.com/alghifrz"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-purple-600 transition-colors"
                aria-label="GitHub"
              ...
              <Link
                href="https://www.instagram.com/agifrz"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-purple-600 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3 text-gray-600">
                ...
                <a href="mailto:alghifarirasyidzola@gmail.com" className="hover:text-purple-600 transition-colors">
                  alghifarirasyidzola@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-3 text-gray-600">
                <svg className="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+6282172772394" className="hover:text-purple-600 transition-colors">
                  +62 821 7277 2394
                </a>
              </li>
            </ul>
